    ...
    <div className="relative bg-slate-900 py-20 px-8 text-center overflow-hidden">
      ...
      <div className="relative z-10">
        ...
        <Link
          href="/resume.pdf"
          download
          className="inline-flex items-center gap-3 bg-sky-400 hover:bg-sky-300 text-slate-900 px-10 py-4 rounded-full text-base font-extrabold tracking-wide no-underline transition-all hover:-translate-y-0.5 hover:shadow-2xl hover:shadow-sky-400/30"
        >
